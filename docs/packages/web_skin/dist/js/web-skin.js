/* ==========================================================
 * wdesk-transition.js v1.14.0 (http://bit.ly/1bh9VJL)
...
/* ==========================================================
 * wdesk-affix.js v1.14.0 (http://bit.ly/15J47Ss)
...
/* ==========================================================
 * wdesk-alert.js v1.14.0 (http://bit.ly/16ZHY1d)
...
/* ==========================================================
 * wdesk-button.js v1.14.0 (http://bit.ly/13EbhbR)
...
/* ==========================================================
 * wdesk-carousel.js v1.14.0 (http://bit.ly/1gLpN84)
...
/* ==========================================================
 * wdesk-collapse.js v1.14.0 (http://bit.ly/15J56BZ)
...
function($) {
    ...
    var Collapse = function(element, options) {
        ...
        this.wrapperClass = o.wrapperSelector.substring(1, o.wrapperSelector.length); // remove the '.'
        this.$wrapper = this.$element.closest(o.wrapperSelector) || this.$element.parent();
        this.$heading = this.$wrapper.find('[class*=head]').first();
        ...
        if (!this.$parent || this.$parent.length < 1) {
            $keyboardNavHandler = this.$element.closest('[role=tablist], [role=tree], [data-collapse-container], ' + o.groupSelector);
        }
    ...
    Collapse.DEFAULTS = {
        ...
        activeClass: 'active',
        groupSelector: '.panel-group',  // the elem that wraps around all the wrappers
        wrapperSelector: '.panel', // the elem that wraps around the clickable control and the collapsible elem
    ...
    Collapse.prototype.show = function(_relatedTarget) {
        ...
        var that = this;
        var o = this.options;
        var classModSeparator = this.wrapperClass === 'card' ? '--' : '-';
        ...
        var groupSelector = (this.options.groupSelector === Collapse.DEFAULTS.groupSelector) ? '[class*=group]' : this.options.groupSelector;
        var currentElems = this.$parent.find('> ' + groupSelector + ' > .in');
        if (currentElems && currentElems.length) {
            this.hideCurrentElems(currentElems, startEvent);
        } else {
            currentElems = this.$parent.find('> ' + groupSelector + ' > ' + this.options.wrapperSelector + ' > .in');
            this.hideCurrentElems(currentElems, startEvent);
        }
        ...
        if (this.$heading === o.initialRelatedTarget) {
            $triggers = this.$heading.add(o.triggerElem);
        } else {
            $triggers = this.$heading.add(o.triggerElem).add(o.initialRelatedTarget);
        }
        ...
        if (that.wrapperClass) {
            that.$wrapper
                .addClass(that.wrapperClass + classModSeparator + 'collapsing')    // something like 'card--collapsing' or 'panel-collapsing'
                .removeClass(that.wrapperClass + classModSeparator + 'collapsed'); // something like 'card--collapsed' or 'panel-collapsed'
        }
        ...
        var complete = function(e) {
            ...
            if (that.wrapperClass) {
                that.$wrapper
                    .removeClass(that.wrapperClass + classModSeparator + 'collapsing'); // something like 'card--collapsing' or 'panel-collapsing'
            }
    ...
    Collapse.prototype.hide = function(_relatedTarget) {
        ...
        var complete = function() {
            ...
            if (that.wrapperClass) {
                that.$wrapper
                    .removeClass(that.wrapperClass + classModSeparator + 'collapsing') // something like 'card--collapsed' or 'panel-collapsed'
                    .addClass(that.wrapperClass + classModSeparator + 'collapsed');    // something like 'card--collapsed' or 'panel-collapsed'
            }
    ...
    Collapse.prototype.keydown = function(event) {
        ...
        var $collapseParent = this.$element.closest(this.options.groupSelector);
...
/* ==========================================================
 * wdesk-datepicker.js v1.14.0 (http://bit.ly/1hdXeCi)
...
/* ==========================================================
 * wdesk-dropdown.js v1.14.0 (http://bit.ly/19iagKq)
...
/* ==========================================================
 * wdesk-inputmask.js v1.14.0 (http://bit.ly/19IOiQj)
...
/* ==========================================================
 * wdesk-modal.js v1.14.0 (http://bit.ly/164zLvx)
...
/* ==========================================================
 * wdesk-scrollspy.js v1.14.0 (http://bit.ly/13E6Cqd)
...
/* ==========================================================
 * wdesk-tab.js v1.14.0 (http://bit.ly/13E6Cqd)
...
/* ==========================================================
 * wdesk-tooltip.js v1.14.0 (http://bit.ly/12iYtta)
...
function($, _) {
    ...
    Tooltip.prototype.show = function(enterEvent) {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var arrowPlacement = typeof o.arrowPlacement == 'function' ?
                o.arrowPlacement.call(this, $tip[0], this.$element[0]) :
                o.arrowPlacement;
            var arrowPlacementClass = false;
            ...
            if (arrowPlacement != 'center') {
                arrowPlacementClass = 'align-arrow-' + arrowPlacement;
            }

            var placementClasses = placement;

            if (arrowPlacementClass) {
                placementClasses += ' ' + arrowPlacementClass;
            }

            $tip
                .detach()
                .css({ top: 0, left: 0, display: 'block' })
                .addClass(placementClasses)
    ...
    Tooltip.prototype.getCalculatedOffset = function(placement, btnOffset, actualWidth, actualHeight) {
        var centerArrowPlacement = this.options.arrowPlacement === 'center';
        var startArrowPlacement = this.options.arrowPlacement === 'start';
        var endArrowPlacement = this.options.arrowPlacement === 'end';

        var offset =  placement == 'bottom' ? { top: btnOffset.top + btnOffset.height,     left: btnOffset.left + btnOffset.width / 2 } :
                      placement == 'top'    ? { top: btnOffset.top - actualHeight,         left: btnOffset.left + btnOffset.width / 2 } :
                      placement == 'left'   ? { top: btnOffset.top + btnOffset.height / 2, left: btnOffset.left - actualWidth    } :
                   /* placement == 'right' */ { top: btnOffset.top + btnOffset.height / 2, left: btnOffset.left + btnOffset.width};

        if (placement === 'bottom' || placement === 'top') {
            if (centerArrowPlacement) {
                offset.left = offset.left - (actualWidth / 2);
            }

            if (endArrowPlacement) {
                offset.left = offset.left - actualWidth;
            }
        }

        if (placement === 'left' || placement === 'right') {
            if (centerArrowPlacement) {
                offset.top = offset.top - (actualHeight / 2);
            }

            if (endArrowPlacement) {
                offset.top = offset.top - actualHeight;
            }
        }
    ...
    Tooltip.prototype.replaceArrow = function(delta, dimension, isHorizontal) {
        var arrowPlacementPos = (this.options.arrowPlacement === 'center')
            ? (50 * (1 - delta / dimension) + '%')
            : '';

        this.arrow()
            .css(isHorizontal ? 'left' : 'top', arrowPlacementPos)
...
/* ==========================================================
 * wdesk-popover.js v1.14.0 (http://bit.ly/14HLYaP)
